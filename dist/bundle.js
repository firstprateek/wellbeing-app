...
/***/ "./src/lib/components/reflection-widget.js":
/*!*************************************************!*\
  !*** ./src/lib/components/reflection-widget.js ***!
  \*************************************************/
...
var ReflectionWidget = /*#__PURE__*/function (_LitElement) {
  function ReflectionWidget() {
    var _this;
    _classCallCheck(this, ReflectionWidget);
    _this = _callSuper(this, ReflectionWidget);
    _this.selectedMood = '';
    return _this;
  }
  _inherits(ReflectionWidget, _LitElement);
  return _createClass(ReflectionWidget, [{
    key: "handleEmojiClick",
    value: function handleEmojiClick(event) {
      this.selectedMood = event.target.textContent.trim();
    ...
    value: function render() {
      ...
      return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <div>\n        ", "\n      </div>\n    "])), emojis.map(function (emoji) {
        return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n            <span\n              class=\"emoji ", "\"\n              @click=\"", "\"\n            >\n              ", "\n            </span>\n          "])), _this2.selectedMood === emoji ? 'selected' : '', _this2.handleEmojiClick, emoji);
      }));
    }
  }]);
}(lit__WEBPACK_IMPORTED_MODULE_0__.LitElement);
_defineProperty(ReflectionWidget, "properties", {
  selectedMood: {
    type: String
  }
});
_defineProperty(ReflectionWidget, "styles", (0,lit__WEBPACK_IMPORTED_MODULE_0__.css)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n    .emoji {\n      font-size: 2rem;\n      cursor: pointer;\n      padding: 0.5rem;\n      transition: transform 0.2s;\n    }\n    .emoji:hover {\n      transform: scale(1.2);\n      border: 1px solid red;\n    }\n    .selected {\n      border: 2px solid #000;\n      border-radius: 50%;\n    }\n  "]))));
...
___CSS_LOADER_EXPORT___.push([module.id, `/* body {
   ...
   */`, "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAAA;;;;;;;;;;;IAWI","sourcesContent":["/* body {\n    background-color: #f0f0f0;\n    font-family: Arial, sans-serif;\n  }\n  \n  div {\n    color: #333;\n    font-size: 2em;\n    text-align: center;\n    margin-top: 20%;\n  }\n   */"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _lib_components_reflection_widget_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./lib/components/reflection-widget.js */ "./src/lib/components/reflection-widget.js");
